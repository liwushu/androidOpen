...
import com.example.camera.CameraApplication;
...
public class SensorController implements  SensorEventListener {
    ...
    private SensorController() {
        mSensorManager = (SensorManager) CameraApplication.getContext().getSystemService(Activity.SENSOR_SERVICE);
...
//                Log.d("pX:" + px + "  pY:" + py + "  pZ:" + pz + "    stamp:"
//                        + stamp + "  second:" + second);
                double value = Math.sqrt(px * px + py * py + pz * pz);
                if (value > 1.4) {
//                    textviewF.setText("检测手机在移动..");
//                    LogUtils.e(TAG,"mobile moving");
                    STATUE = STATUS_MOVE;
                } else {
//                    textviewF.setText("检测手机静止..");
//                    LogUtils.e(TAG,"mobile static");
                    //上一次状态是move，记录静态时间点
...
//                                LogUtils.e(TAG,"mobile focusing");
                            }
                        }
                    }
