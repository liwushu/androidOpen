...
public class TestFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_test_fragment5, container, false);
    }
    ...
    public void onResume(){
        super.onResume();
        LogUtils.logd("flying","TestFragment3_onResume: "+isVisible);
    }

    @Override
    public void onPause(){
        super.onPause();
        LogUtils.logd("flying","TestFragment3_onPause: "+isVisible);
    }
}
