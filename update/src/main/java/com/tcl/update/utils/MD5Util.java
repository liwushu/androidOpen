...
public class MD5Util {
    ...
    /*
     * public static String MDEEncodeByUrl(String url) throws MalformedURLException, IOException{
     * URLConnection uc = new URL(url).openConnection(); InputStream input = uc.getInputStream();
     * String md5 = DigestUtils.md5Hex(IOUtils.toByteArray(input)); IOUtils.closeQuietly(input);
     * return md5; }
     * 
     * public static String MDEEncodeByByte(byte [] bytes){ String md5 = DigestUtils.md5Hex(bytes);
     * return md5; }
     */
}
