...
public class ZlibUtil {
    ...
    public static int compress(InputStream is, OutputStream os) throws IOException {
    ...
    public static int uncompress(InputStream is, OutputStream os) throws IOException {
    ...
    public static int uncompress(byte[] compressBytes, int offset, int len, OutputStream os) throws IOException {
        if (compressBytes == null || compressBytes.length < (offset + len)) return 0;
    ...
    public static byte[] uncompress(byte[] compressBytes) throws IOException {
        if (compressBytes == null || compressBytes.length == 0) return null;
