...
import com.ubt.alaph2.download.DownloadConfiguration;
...
import com.ubt.alaph2.download.impl.IConnectTask;
 ...
 * @modify: liwushu
*/
public class DownloaderImpl implements IDownloader, IConnectTask.OnConnectListener, DownloadTask.OnDownloadListener {
